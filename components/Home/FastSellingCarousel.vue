        ...
        <div v-for="(item, index) in items" :key="index" class="item">
          <div class="product-wrap">
            <div class="product-img">
              <img :src="item.product.images.length > 0 ? item.product.images[0].image_url : '/images/product/finalimage.png'" alt=""/>
            </div>
            <div class="product-content fix">
              <div class="row">
                <div class="col-6">
                  <h3 style="cursor: pointer">
                    <a>{{ item.product.category_name }}</a>
                  </h3>
                ...
                <div class="col-6 d-flex flex-column" style="text-align: end">
                  ...
                  <span>
                    <del style="color: #8e8e8e; font-size: 12px;">
                      ₹{{ parseFloat(item.product.comp_price).toFixed(2) }}
                    </del>
